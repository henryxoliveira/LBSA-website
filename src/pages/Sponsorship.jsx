...
const Sponsorship = () => {
  const sponsors = [
    { name: 'Amazon', logo: '/src/assets/img/amazonlogo.png' },
    { name: 'Deloitte', logo: '/src/assets/img/deloittelogo.avif' },
    { name: 'Google', logo: '/src/assets/img/googlelogo.webp' },
    { name: 'KPMG', logo: '/src/assets/img/kpmglogoo.png' },
    { name: 'Moss', logo: '/src/assets/img/mosslogo.jpg' },
    { name: 'PwC', logo: '/src/assets/img/pwclogo.jpg' },
    { name: 'Snowflake', logo: '/src/assets/img/snowflakelogo.svg' },
    { name: 'Target', logo: '/src/assets/img/targetlogo.jpg' }
  ]
