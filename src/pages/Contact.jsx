      ...
      <section className="bg-cardinal text-white py-20">
        <div className="container text-center">
          ...
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">
            Have questions about LBSA? Want to get involved? We'd love to hear from you. 
          ...
          <div className="grid md:grid-2 gap-12">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-cardinal text-white py-3 px-6 rounded-lg font-semibold hover:bg-red-700 transition"
                >
                  Send Message
                </button>
              </form>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:lbsa@scu.edu" className="text-cardinal hover:text-red-700">
                          lbsa@scu.edu
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+1-408-554-4000" className="text-cardinal hover:text-red-700">
                          (408) 554-4000
                        </a>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      className="w-10 h-10 bg-cardinal rounded-full flex items-center justify-center text-white hover:bg-red-700 transition"
        ...
        <div className="container">
          ...
          <div className="grid md:grid-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-semibold mb-3">How do I join LBSA?</h3>
              <p className="text-gray-600">
                Attend one of our events, submit an application, and complete a brief interview. 
                Visit our <a href="/membership" className="text-cardinal hover:text-red-700">Membership page</a> for more details.
              </p>
            </div>
            
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-semibold mb-3">What events do you host?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-semibold mb-3">Are there membership fees?</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-lg font-semibold mb-3">How can companies partner with LBSA?</h3>
              <p className="text-gray-600">
                We offer various sponsorship tiers and custom partnership opportunities. 
                Visit our <a href="/sponsorship" className="text-cardinal hover:text-red-700">Sponsorship page</a> for more information.
              </p>
            </div>
          </div>
        </div>
